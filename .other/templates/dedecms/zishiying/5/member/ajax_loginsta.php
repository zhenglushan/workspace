...
?>
<ul class="top-menu"><li><i class="fa fa-github-square"></i>你好：<strong><?php echo $cfg_ml->M_UserName; ?></strong>，欢迎登录！<a href="<?php echo $cfg_memberurl; ?>/index_do.php?fmdo=login&dopost=exit">退出登录</a> </li></ul>
<!--<div class="userinfo">
