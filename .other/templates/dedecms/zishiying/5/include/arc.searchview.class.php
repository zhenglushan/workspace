...
class SearchView
{
    ...
    function GetPageListDM($list_len)
    {
        ...
        $infos = "<a>共找到<b>".$this->TotalResult."</b>条记录/最大显示<b>{$totalpage}</b>页 </a>\r\n";
        ...
        for($j; $j<=$total_list; $j++)
        {
            ...
            {
                $listdd.="<a href='".$purl."PageNo=$j'>".$j."</a>&nbsp;</td>\r\n";
            }
        }
       // $plist  =  "<table border='0' cellpadding='0' cellspacing='0'>\r\n";
        ...
        {
            $plist.="<a><input type='text' name='PageNo' style='width:28px;height:14px' value='".$this->PageNo."' /></a>\r\n";
            $plist.="<a><input type='submit' name='plistgo' value='GO' style='width:30px;height:22px;font-size:9pt' /></a>\r\n";
        }
        $plist .= "</form>\r\n";
        //$plist .= "</form>\r\n</tr>\r\n</table>\r\n";
        return $plist;
