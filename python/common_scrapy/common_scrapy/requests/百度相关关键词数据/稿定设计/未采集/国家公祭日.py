...
if __name__ == '__main__':
    ...
    应该在采集完成之后，再进行过滤
    """
    keyword_dir = "国家公祭日"  # 要采集的关键词目录名称
    filter_word = [
        ["国家公祭日"],  # 必须包含某个关键词
        ["图片", "素材", "模板", "海报", "设计"]  # 必须包含某个关键词
    ]
    keyword_arr = ["国家公祭日图片", "国家公祭日素材", "国家公祭日模板", "国家公祭日海报", "国家公祭日设计"]
    ...
    for i in range(1, level_number + 1):
        ...
        if lines:
            ...
            GuoJiaGongJiRi(lines, filter_word, save_kw_file_path)