...
if __name__ == '__main__':
    ...
    应该在采集完成之后，再进行过滤
    """
    keyword_dir = "儿童节"  # 要采集的关键词目录名称
    filter_word = [
        ["儿童节"],  # 必须包含某个关键词
        ["图片", "素材", "模板", "海报", "设计"]  # 必须包含某个关键词
    ]
    keyword_arr = ["儿童节图片", "儿童节素材", "儿童节模板", "儿童节海报", "儿童节设计","六一儿童节图片", "六一儿童节素材", "六一儿童节模板", "六一儿童节海报", "六一儿童节设计"]
    ...
    for i in range(1, level_number + 1):
        ...
        if lines:
            ...
            ErTongJie(lines, filter_word, save_kw_file_path)