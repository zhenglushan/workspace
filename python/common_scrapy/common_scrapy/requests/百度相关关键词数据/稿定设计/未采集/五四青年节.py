...
if __name__ == '__main__':
    ...
    应该在采集完成之后，再进行过滤
    """
    keyword_dir = "五四青年节"  # 要采集的关键词目录名称
    filter_word = [
        ["五四青年节"],  # 必须包含某个关键词
        ["图片", "素材", "模板", "海报", "设计"]  # 必须包含某个关键词
    ]
    keyword_arr = ["青年节图片", "青年节素材", "青年节模板", "青年节海报", "青年节设计","五四青年节图片", "五四青年节素材", "五四青年节模板", "五四青年节海报", "五四青年节设计"]
    ...
    for i in range(1, level_number + 1):
        ...
        if lines:
            ...
            WuSiQingNianJie(lines, filter_word, save_kw_file_path)