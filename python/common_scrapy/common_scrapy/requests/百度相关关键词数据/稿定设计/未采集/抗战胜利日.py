...
if __name__ == '__main__':
    ...
    应该在采集完成之后，再进行过滤
    """
    keyword_dir = "抗战胜利日"  # 要采集的关键词目录名称
    filter_word = [
        ["抗战胜利日"],  # 必须包含某个关键词
        ["图片", "素材", "模板", "海报", "设计"]  # 必须包含某个关键词
    ]
    keyword_arr = ["抗战胜利日图片", "抗战胜利日素材", "抗战胜利日模板", "抗战胜利日海报", "抗战胜利日设计"]
    ...
    for i in range(1, level_number + 1):
        ...
        if lines:
            ...
            KangZhanShengLiRi(lines, filter_word, save_kw_file_path)