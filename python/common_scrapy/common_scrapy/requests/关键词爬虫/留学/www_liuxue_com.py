...
#     fulldomain = 'http://www.liuxue.com/'
#     name = get_name(fulldomain)
#     table_name = "留学" + '_' + name  # 保存数据的表名
#     root_domain = get_root_domain(fulldomain)
#     host = get_host(fulldomain)
#     allowed_domains = [host]
#     start_urls = [fulldomain]
#
#     rules = [
#         Rule(
#             LinkExtractor(allow=("www.liuxue.com/.*/$")), process_request='process_request',
#             process_links='process_other', follow=is_follow),
#
#         Rule(
#             LinkExtractor(allow=("www.liuxue.com.*/\d+.html$")), process_links='process_links',
...
#
#             if len(title) == 0:
#                 title = response.css("div.detail-left-main.top-detail h1.detail-title::text")
#                 if not title:
#                     title = response.css("div.detail-left-main.top-detail h1.detail-title::text")
#                 if title:
...
#             tempbody = ''
#             tbody = response.css("div.detail-left-main.top-detail div.detail-summary")
#             if tbody:
#                 tbody = tbody.extract()[0]
#                 tempbody = tempbody + tbody
#
#             tbody = response.css("div.detail-left-main.top-detail div.article-infomation")
#             if tbody:
#                 tbody = tbody.extract()[0]
#                 tempbody = tempbody + tbody
#
...
#
#                 tbody = tbody.replace('400-104-9966', '').replace('顺顺', '')
...
#     execute(['scrapy', 'crawl', 'www_liuxue_com'])
