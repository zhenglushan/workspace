...
#     fulldomain = 'https://www.icheruby.com/'
...
#
#     start_urls = [
#         'https://www.icheruby.com/',
#         "https://www.icheruby.com/ask/",
#         "https://www.icheruby.com/baike/",
#         "https://www.icheruby.com/news/",
#         "https://www.icheruby.com/case/",
#     ]
#
#     rules = [
#         Rule(
#             LinkExtractor(allow=("/[a-z]+/.*/$", "/index_\d+.html$")), process_request='process_request',
#             follow=is_follow),
#
#         Rule(
#             LinkExtractor(allow=("/ask/\d+.html$", "/baike/\d+.html$", "/news/\d+.html$", "/case/\d+.html$")),
...
#             if len(title) == 0:
#                 title = response.css("div.content-top-One::text")
#                 if title:
#                     title = title.extract()[0]
#                     title = filter_title(title)
#
#             teamp_body = response.css("div.Article-content")
#             if teamp_body:
#                 teamp_body = teamp_body.extract()
#                 teamp_body = "".join(teamp_body)
#
#                 re_sub = '<div class="text-fr".*'
...
#     execute(['scrapy', 'crawl', 'www_icheruby_com'])
