...
#     fulldomain = 'http://www.91hkbb.com/'
...
#     rules = [
#         Rule(
#             LinkExtractor(allow=("/category/.*$")), process_request='process_request', follow=is_follow),
#
#         Rule(
#             LinkExtractor(allow=("/detail/id/\d+.html$")), process_links='process_links',
#             process_request='process_request', callback='parse_detail', follow=is_follow),
#     ]
...
#     execute(['scrapy', 'crawl', 'www_91hkbb_com'])
