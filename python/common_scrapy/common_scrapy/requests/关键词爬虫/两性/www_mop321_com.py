...
#     fulldomain = 'https://www.mop321.com/'
#     name = get_name(fulldomain)
#     table_name = "两性" + '_' + name  # 保存数据的表名
...
#
#     start_urls = [
#                      "https://www.mop321.com/jiankang/list_1_1.html",
#                      "https://www.mop321.com/baojian/list_2_1.html",
#                      "https://www.mop321.com/shenghuo/list_3_1.html",
#                      "https://www.mop321.com/zhishi/list_4_1.html",
#                      "https://www.mop321.com/xinli/list_5_1.html",
#                      "https://www.mop321.com/jiqiao/list_6_1.html",
#                      "https://www.mop321.com/qinggan/list_7_1.html",
#                  ] + [
#                      "https://www.mop321.com/jiankang/list_1_%d.html" % p for p in range(2, 10)
#                  ] + [
#                      "https://www.mop321.com/baojian/list_2_%d.html" % p for p in range(2, 10)
#                  ] + [
#                      "https://www.mop321.com/shenghuo/list_3_%d.html" % p for p in range(2, 10)
#                  ] + [
#                      "https://www.mop321.com/zhishi/list_4_%d.html" % p for p in range(2, 10)
#                  ] + [
#                      "https://www.mop321.com/xinli/list_5_%d.html" % p for p in range(2, 10)
#                  ] + [
#                      "https://www.mop321.com/jiqiao/list_6_%d.html" % p for p in range(2, 10)
#                  ] + [
#                      "https://www.mop321.com/qinggan/list_7_%d.html" % p for p in range(2, 10)
#                  ]
#
...
#         con_urls = response.css("ul.article-list.top-news li.media div.media-body h2 a::attr(href)")
#         if con_urls:
#             con_urls = con_urls.extract()
#             # con_urls.append('https://www.mop321.com/shenghuo/1316383.html')
#             # con_urls.append('https://www.mop321.com/shenghuo/1316.html')
...
#         #     qz_reg = "<div class=[\"\']pagelist[\"\']>.*?<li class=[\"\']thisclass[\"\']><a>\d+</a></li>"
...
#             if len(title) == 0:
#                 title = response.css("div.article-header h1.title::text")
#                 if title:
#                     title = title.extract()[0]
#                     title = filter_title(title)
#
#             tbody = response.css("div#main-content.content")
#             if tbody:
#                 tbody = tbody.extract()[0]
#                 re_sub = '_cke_saved_src=[\'\"].*?[\'\"]'
...
#     execute(['scrapy', 'crawl', 'www_mop321_com'])
