...
#
#     start_urls = [
#                      "https://www.domop.cc/liangxing/xingzhishi/p1.html",
#                      "https://www.domop.cc/liangxing/xingjiqiao/p1.html",
#                      "https://www.domop.cc/liangxing/xingjiaoyu/p1.html",
#                      "https://www.domop.cc/liangxing/xingxinli/p1.html",
#                      "https://www.domop.cc/liangxing/qinggan/p1.html",
#                  ] + [
#                      "https://www.domop.cc/liangxing/xingzhishi/p%d.html" % p for p in range(2, 11)
#                  ] + [
#                      "https://www.domop.cc/liangxing/xingjiqiao/p%d.html" % p for p in range(2, 11)
#                  ] + [
#                      "https://www.domop.cc/liangxing/xingjiaoyu/p%d.html" % p for p in range(2, 11)
#                  ] + [
#                      "https://www.domop.cc/liangxing/xingxinli/p%d.html" % p for p in range(2, 11)
#                  ] + [
#                      "https://www.domop.cc/liangxing/qinggan/p%d.html" % p for p in range(2, 11)
#                  ]
...
#         con_urls = response.css("div.list_item.clears ul li h3 a::attr(href)")
#         if con_urls:
#             con_urls = con_urls.extract()
#             # con_urls.append('https://www.domop.cc/liangxing/qinggan/842937.html')
#             # con_urls.append('https://www.domop.cc/liangxing/qinggan/843097.html')
...
#         #     qz_reg = "<div class=[\"\']list_gg[\"\']>.*?<li class=[\"\']thisclass[\"\']>\d+</li>"
...
#             if len(title) == 0:
#                 title = response.css("div.content_tit h1::text")
#                 if title:
#                     title = title.extract()[0]
#                     title = filter_title(title)
#
#             tbody = response.css("div.content_left div.content_text")
#             if tbody:
...
#     execute(['scrapy', 'crawl', 'www_domop_cc'])
