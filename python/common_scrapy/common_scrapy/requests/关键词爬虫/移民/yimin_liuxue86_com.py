...
#     fulldomain = 'https://yimin.liuxue86.com/'
#     name = get_name(fulldomain)
#     table_name = "移民" + '_' + name  # 保存数据的表名
...
#         Rule(
#             LinkExtractor(
#                 allow=("/[a-z]{2,}/$", "/[a-z]{2,}/[a-z]{2,}/$", "/[a-z]{2,}/\d+.html$", "/[a-z]{2,}/[a-z]{2,}/\d+/$")),
#             process_request='process_request', follow=is_follow),
#
#         Rule(
#             LinkExtractor(allow=("yimin.liuxue86.com/[a-z]/\d+.html$")), process_links='process_links',
...
#             if len(title) == 0:
#                 title = response.css("div.conter_main_one.clearfix h1 a::text")
#                 if title:
#                     title = title.extract()[0]
#                     title = filter_title(title)
#
#             teamp_body = response.css('div#article-content.main_zhengw')
#
#             if teamp_body:
...
#     execute(['scrapy', 'crawl', 'yimin_liuxue86_com'])
