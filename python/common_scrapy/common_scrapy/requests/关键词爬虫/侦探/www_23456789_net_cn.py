...
#     fulldomain = 'http://www.23456789.net.cn/'
...
#                     title = title.replace("真相", "[$城市$]").replace("重庆", "[$城市$]")
#
#             teamp_body = response.css("div.maincontent.clearfix")
#
#             if teamp_body:
...
#
#                 teamp_body = teamp_body.replace("真相", "[$城市$]").replace("重庆", "[$城市$]")
#
...
#     execute(['scrapy', 'crawl', 'www_23456789_net_cn'])
