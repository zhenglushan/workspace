...
#     fulldomain = 'http://www.kezhang6.cn/'
#     name = get_name(fulldomain)
#     table_name = "刻章" + '_' + name  # 保存数据的表名
...
#     execute(['scrapy', 'crawl', 'www_kezhang6_cn'])
