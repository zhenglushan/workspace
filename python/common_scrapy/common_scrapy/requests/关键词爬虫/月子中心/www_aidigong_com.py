...
#     fulldomain = 'http://www.aidigong.com/'
#     name = get_name(fulldomain)
#     table_name = "月子中心" + '_' + name  # 保存数据的表名
...
#     start_urls = [
#         fulldomain,
#         'http://www.aidigong.com/news/',
#     ]
#
#     rules = [
#         Rule(
#             LinkExtractor(allow=("/news/.*/$", "/index_\d+.html")), process_request='process_request',
#             follow=is_follow),
#
#         Rule(
...
#     execute(['scrapy', 'crawl', 'www_aidigong_com'])
