...
#     name = 'search_sohu_com_banyongjiu'
#     table_name = "半永久" + '_' + 'search_sohu_com_banyongjiu'  # 保存数据的表名
#     root_domain = 'sohu.com'
#
#     start_urls = [
#         'http://search.sohu.com/search/meta?keyword=半永久&terminalType=pc&spm-pre=smpc.csrpage.0.0.15615184009643jp4p2G&SUV=190625141446T0OJ&from=%d&size=10&searchType=news&queryType=outside&queryId=15615184001075Y2K015&pvId=15615184009643jp4p2G&refer=' % (
...
#     execute(['scrapy', 'crawl', 'search_sohu_com_banyongjiu'])
