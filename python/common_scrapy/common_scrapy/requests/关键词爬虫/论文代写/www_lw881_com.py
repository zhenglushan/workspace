...
#     fulldomain = 'http://www.lw881.com/'
#     name = get_name(fulldomain)
#     table_name = "论文代写" + '_' + name  # 保存数据的表名
...
#     rules = [
#         Rule(
#             LinkExtractor(allow=("/[a-z]+/.*/$", "/list.*.html$")), process_request='process_request',
#             follow=is_follow),
#
#         Rule(
#             LinkExtractor(allow=("www.lw881.com.*/\d+.html$"), deny=('/zt/', '/qk/', '/z/')),
...
#
#             if len(title) == 0:
#                 title = response.css("div.top_tit h1::text")
#                 if not title:
...
#     execute(['scrapy', 'crawl', 'www_lw881_com'])
