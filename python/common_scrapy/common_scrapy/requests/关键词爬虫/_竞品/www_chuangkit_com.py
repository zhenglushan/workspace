...
#     fulldomain = 'https://www.chuangkit.com/'
...
#         Rule(
#             LinkExtractor(
#                 allow=("/designtools/$", "/designtools/startdesign$", "/[a-z0-9\-]+.html$",
#                        "/templatecenter/[a-z0-9\-]+.html$", "/tupian/[a-z0-9\-]+.html$",
#                        "/shejiimg/[a-z0-9\-]+.html$")),
#             process_request='process_request',
#             follow=is_follow),
#     ]
#
...
#         keywords = response.css("div.template-tags span.template-tags-item a.single-tag::text")
#         if keywords:
#             keywords = keywords.extract()
#             keywords = "\n".join(keywords)
...
#     execute(['scrapy', 'crawl', 'www_chuangkit_com'])
