...
#     name = 'search_sohu_com_hunyindiaocha'
#     table_name = "婚姻调查" + '_' + name  # 保存数据的表名
#     root_domain = 'sohu.com'
#
#     start_urls = [
#                      'http://search.sohu.com/search/meta?keyword=婚姻调查&terminalType=pc&spm-pre=smpc.csrpage.0.0.15615184009643jp4p2G&SUV=190625141446T0OJ&from=%d&size=10&searchType=news&queryType=outside&queryId=15615184001075Y2K015&pvId=15615184009643jp4p2G&refer=' % (
#                              p * 10) for p in range(0, 50)
#                  ] + [
#                      'http://search.sohu.com/search/meta?keyword=婚外情调查&terminalType=pc&spm-pre=smpc.csrpage.0.0.15615184009643jp4p2G&SUV=190625141446T0OJ&from=%d&size=10&searchType=news&queryType=outside&queryId=15615184001075Y2K015&pvId=15615184009643jp4p2G&refer=' % (
#                              p * 10) for p in range(0, 50)
#                  ]
#
...
#     execute(['scrapy', 'crawl', 'search_sohu_com_hunyindiaocha'])
