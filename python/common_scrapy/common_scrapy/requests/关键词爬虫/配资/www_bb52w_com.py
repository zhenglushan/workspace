...
#     rules = [
#         Rule(
#             LinkExtractor(allow=("/[a-z]+/$", "/index_\d+.shtml")),
#             process_request='process_request',
#             follow=is_follow),
#
#         Rule(
#             LinkExtractor(allow=("/[a-z]+/\d+.shtml$")), process_links='process_links',
#             process_request='process_request',
...
#             if len(title) == 0:
#                 title = response.css("div.content-warp h1.view-title::text")
#                 if title:
#                     title = title.extract()[0]
#                     title = filter_title(title)
#
#             teamp_body = response.css("div.content-warp div.view-content")
#             if not teamp_body:
...
#     execute(['scrapy', 'crawl', 'www_bb52w_com'])
