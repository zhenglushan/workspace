...
#     fulldomain = 'https://www.meituri.com/'
#     name = get_name(fulldomain)
#     table_name = "美女图片" + '_' + name  # 保存数据的表名
#     root_domain = get_root_domain(fulldomain)
#     start_urls = [
#         "https://www.meituri.com/s/35/",
#         "https://www.meituri.com/s/59/",
#         "https://www.meituri.com/s/54/",
#         "https://www.meituri.com/s/83/",
#         "https://www.meituri.com/s/13/",
#         "https://www.meituri.com/s/149/",
#         "https://www.meituri.com/s/24/",
#         "https://www.meituri.com/s/49/",
#         "https://www.meituri.com/s/74/",
#         "https://www.meituri.com/s/80/",
#         "https://www.meituri.com/s/47/",
#         "https://www.meituri.com/s/31/",
#         "https://www.meituri.com/s/15/",
#         "https://www.meituri.com/s/150/",
#         "https://www.meituri.com/s/16/",
#         "https://www.meituri.com/s/186/",
#     ]
#
#     # start_urls = start_urls + [
#     #     'https://www.7160.com/xingganmeinv/list_3_%d.html' % pn for pn in range(2, 302)
#     # ] + [
#     #                  'https://www.7160.com/rentiyishu/list_1_%d.html' % pn for pn in range(2, 101)
#     #              ]
#
...
#         con_urls = response.css("div.hezi ul li > a::attr(href)")
#         if con_urls:
...
#             re_sub = "<a href=[\"\'](/s/\d+/index_\d+\.html)[\"\'] class=[\"\']next[\"\']>下一页</a>"
...
#         if len(title) == 0:
#             title = response.css("div.weizhi h1::text")
#             if title:
#                 title = title.extract()[0]
#                 title = filter_title(title)
#
#         body = response.meta['body']
#         tbody = response.css("div.content img")
#         if tbody:
#             tbody = tbody.extract()
#             tbody = "[zlspage]".join(tbody)
...
#             body = body + tbody
#
#         re_sub = "<a class=[\"\']a1[\"\'] href=[\"\'](" + self.fulldomain + "a/\d+/\d+.html)[\"\']>下一页</a>"
...
#     execute(['scrapy', 'crawl', 'www_meituri_com'])
