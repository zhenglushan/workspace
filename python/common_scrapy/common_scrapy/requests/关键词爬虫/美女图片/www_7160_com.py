...
#         con_urls = response.css("div.news_bom-left div.new-img ul li a::attr(href)")
#         if con_urls:
...
#         if len(title) == 0:
#             title = response.css("div.picmainer h1::text")
#             if title:
#                 title = title.extract()[0]
#                 title = filter_title(title)
#
#         body = response.meta['body']
#         tbody = response.css("div.picsbox.picsboxcenter p a img")
#         if not tbody:
#             tbody = response.css("div.picsbox.picsboxcenter p img")
#         if tbody:
...
#             body = body + tbody
#
#         re_sub = "<a href=[\"\'](index_\d+.html)[\"\']>下一页</a>"
...
#     execute(['scrapy', 'crawl', 'www_7160_com'])
