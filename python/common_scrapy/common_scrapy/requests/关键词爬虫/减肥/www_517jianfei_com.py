...
#     fulldomain = 'https://www.517jianfei.com/'
#     name = get_name(fulldomain)
#     table_name = "减肥" + '_' + name  # 保存数据的表名
#     root_domain = get_root_domain(fulldomain)
#
#     start_urls = [
#                      "https://www.517jianfei.com/jianfeifangfa/list_1_1.html",
#                      "https://www.517jianfei.com/jianfeishipu/list_2_1.html",
#                      "https://www.517jianfei.com/mingxingjianfei/list_3_1.html",
#                      "https://www.517jianfei.com/jubujianfei/list_4_1.html",
#                      "https://www.517jianfei.com/yundongjianfei/list_5_1.html",
#                      "https://www.517jianfei.com/yujiajianfei/list_6_1.html",
#                      "https://www.517jianfei.com/jiankangceshi/list_7_1.html",
#                      "https://www.517jianfei.com/zhuangjiazhidao/list_8_1.html",
#                      "https://www.517jianfei.com/jianfeiyao/list_9_1.html",
#                      "https://www.517jianfei.com/wenda/list_10_1.html",
#                  ] + ["https://www.517jianfei.com/jianfeifangfa/list_1_%d.html" % p for p in range(2, 11)
#                       ] + [
#                      "https://www.517jianfei.com/jianfeishipu/list_2_%d.html" % p for p in range(2, 11)
#                  ] + [
#                      "https://www.517jianfei.com/mingxingjianfei/list_3_%d.html" % p for p in range(2, 11)
#                  ] + [
#                      "https://www.517jianfei.com/jubujianfei/list_4_%d.html" % p for p in range(2, 11)
#                  ] + [
#                      "https://www.517jianfei.com/yundongjianfei/list_5_%d.html" % p for p in range(2, 11)
#                  ] + [
#                      "https://www.517jianfei.com/yujiajianfei/list_6_%d.html" % p for p in range(2, 11)
#                  ] + [
#                      "https://www.517jianfei.com/jiankangceshi/list_7_%d.html" % p for p in range(2, 11)
#                  ] + [
#                      "https://www.517jianfei.com/zhuangjiazhidao/list_8_%d.html" % p for p in range(2, 11)
#                  ] + [
#                      "https://www.517jianfei.com/jianfeiyao/list_9_%d.html" % p for p in range(2, 11)
#                  ] + [
#                      "https://www.517jianfei.com/wenda/list_10_%d.html" % p for p in range(2, 11)
#                  ]
#
...
#         con_urls = response.css("ul#list li.list_tit a::attr(href)")
#         if con_urls:
...
#         #     qz_reg = "<ul class=[\"\']pagelist[\"\'] id=[\"\']pagelist[\"\']>.*?<li class=[\"\']thisclass[\"\']>\d+</li>"
...
#     execute(['scrapy', 'crawl', 'www_517jianfei_com'])
