...
#     fulldomain = 'http://www.zuanqian.net/'
#     name = get_name(fulldomain)
#     table_name = "网赚" + '_' + name  # 保存数据的表名
...
#     rules = [
#         Rule(
#             LinkExtractor(allow=("/page/\d+/$")), process_request='process_request', follow=is_follow),
#         Rule(
...
#             if houzhui == -1:
#                 houzhui = response.text.find('<div class="bdsharebuttonbox">', qianzhui, -1)
...
#     execute(['scrapy', 'crawl', 'www_zuanqian_net'])
