...
#     fulldomain = 'http://www.szdianshangzhijia.com/'
#     name = get_name(fulldomain)
#     table_name = "代运营" + '_' + name  # 保存数据的表名
#     root_domain = get_root_domain(fulldomain)
#     host = get_host(fulldomain)
#     allowed_domains = [host]
#     start_urls = [
#         fulldomain,
#         'http://www.szdianshangzhijia.com/operate/',
#         'http://www.szdianshangzhijia.com/information/',
#         'http://www.szdianshangzhijia.com/company/',
#         'http://www.szdianshangzhijia.com/tmall/',
#         'http://www.szdianshangzhijia.com/taobao/',
#         'http://www.szdianshangzhijia.com/jd/',
#         'http://www.szdianshangzhijia.com/renovation/',
#         'http://www.szdianshangzhijia.com/reputation/',
#         'http://www.szdianshangzhijia.com/make/',
#     ]
#
#     rules = [
#         Rule(
#             LinkExtractor(allow=("/list_\d+.html$")), process_request='process_request',
#             process_links='process_other', follow=is_follow),
#
#         Rule(
#             LinkExtractor(allow=("/\d+.html$")), process_links='process_links', process_request='process_request',
...
#
#         if len(title) == 0:
#             title = response.css("div.right h2 span::text")
#             if title:
#                 title = title.extract()[0]
#                 title = filter_title(title)
#
#         tbody = response.css("div.right div.article_body")
#         if tbody:
#             tbody = tbody.extract()
#             tbody = ''.join(tbody)
#             tbody = tbody.replace('<div', '<p').replace('</div>', '</p>').replace('<u>', '').replace('</u>', '')
...
#     execute(['scrapy', 'crawl', 'www_szdianshangzhijia_com'])
