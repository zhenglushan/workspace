...
#     rules = [
#         Rule(
#             LinkExtractor(allow=("/?cat=\d+$", "/page/\d+/$")), process_request='process_request',
#             process_links='process_other', follow=is_follow),
#
#         Rule(
#             LinkExtractor(allow=("/?p=\d+$")), process_links='process_links', process_request='process_request',
...
#
#         if len(title) == 0:
#             title = response.css("header.article-header h1.article-title::text")
#             if title:
...
#     execute(['scrapy', 'crawl', 'www_iw114_com'])
