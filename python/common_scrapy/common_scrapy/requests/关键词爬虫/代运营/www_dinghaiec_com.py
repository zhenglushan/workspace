...
#     fulldomain = 'https://www.dinghaiec.com/'
...
#
#     rules = [
#         Rule(LinkExtractor(allow="/listinfo.*.html$"), process_request='process_request', follow=is_follow),
#         Rule(LinkExtractor(allow="/showinfo.*.html$"), process_links='process_links', process_request='process_request',
...
#         if len(title) == 0:
#             title = response.css("div.title_center strong::text")
#             if not title:
#                 title = response.css("figure.newsdet-title figcaption::text")
#             if title:
#                 title = title.extract()[0]
#                 title = filter_title(title)
#
#         body = response.meta['c_body']
#         tbody = response.css("div#mainbody.mainbody")
#         if not tbody:
#             tbody = response.css("div.newsdet-content")
#         if tbody:
#             tbody = tbody.extract()
#             tbody = ''.join(tbody)
...
#     execute(['scrapy', 'crawl', 'www_dinghaiec_com'])
