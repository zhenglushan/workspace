...
#     fulldomain = 'https://www.eszmc.com/'
#     name = get_name(fulldomain)
#     table_name = "曝光" + '_' + name  # 保存数据的表名
#     root_domain = get_root_domain(fulldomain)
#     host = get_host(fulldomain)
#     start_urls = [
#         "https://www.eszmc.com/jiaju/",
#         "https://www.eszmc.com/logo/",
#         "https://www.eszmc.com/yiyuan/",
#         "https://www.eszmc.com/jin/",
#         "https://www.eszmc.com/shi/",
#         "https://www.eszmc.com/life/",
#         "https://www.eszmc.com/jiao/",
#         "https://www.eszmc.com/xun/",
#         "https://www.eszmc.com/yezhu/",
#         "https://www.eszmc.com/laowu/",
#         "https://www.eszmc.com/she/",
#     ]
#
...
#         con_urls = response.css("div.listl.list2 ul li h3 a::attr(href)")
#         if con_urls:
...
#             result = response.css('div.page li.thisclass + li a::attr(href)')
#             if result:
...
#             if len(title) == 0:
#                 title = response.css("div.listltitle h3::text")
#                 if title:
...
#             # # 前后截取正文 开始
#             # qianzhui = 0
#             # qianzhui_temp = re.finditer('<div class="mip-detail-content">', response.text)
#             # for qz in qianzhui_temp:
#             #     end = qz.end()
#             #     qianzhui = end
#             # houzhui = response.text.find('<div class="mip-share-container">', qianzhui)
#             # tbody = response.text[qianzhui:houzhui]
#             # # 前后截取正文 结束
#             tbody = response.css("div.article-content")
#             if tbody:
#                 tbody = tbody.extract()
#                 tbody = ''.join(tbody)
#                 tbody = filter_common_html(tbody)  # 过滤常见的 HTML 标签和属性
#                 tbody = tbody.replace('<p>&nbsp;</p>', '')
#                 body = body + tbody
#
#                 # 正文存在，才需要继续下一页
...
#     execute(['scrapy', 'crawl', 'www_eszmc_com'])
