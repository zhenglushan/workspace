...
#     name = 'search_sohu_com_daiyun'
#     table_name = "代孕" + '_' + name  # 保存数据的表名
#     root_domain = 'sohu.com'
#
#     start_urls = [
#         'http://search.sohu.com/search/meta?keyword=代孕&terminalType=pc&spm-pre=smpc.csrpage.0.0.15615184009643jp4p2G&SUV=190625141446T0OJ&from=%d&size=10&searchType=news&queryType=outside&queryId=15615184001075Y2K015&pvId=15615184009643jp4p2G&refer=' % (
...
#     execute(['scrapy', 'crawl', 'search_sohu_com_daiyun'])
