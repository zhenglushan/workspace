...
#     fulldomain = 'https://huaiyun.pcbaby.com.cn/'
#     name = get_name(fulldomain)
#     table_name = "怀孕" + '_' + name  # 保存数据的表名
#     root_domain = get_root_domain(fulldomain)
#
#     start_urls = [
#                      "https://huaiyun.pcbaby.com.cn/yunqian/zhunbei/",
#                      "https://huaiyun.pcbaby.com.cn/yunqian/shengyu/",
#                      "https://huaiyun.pcbaby.com.cn/yunqian/yichuan/",
#                      "https://huaiyun.pcbaby.com.cn/fenmian/daichan/",
#                      "https://huaiyun.pcbaby.com.cn/fenmian/fangshi/",
#                  ] + [
#                      "https://huaiyun.pcbaby.com.cn/yunqian/zhunbei/index_%d.html" % p for p in range(1, 10)
#                  ] + [
#                      "https://huaiyun.pcbaby.com.cn/yunqian/shengyu/index_%d.html" % p for p in range(1, 10)
#                  ] + [
#                      "https://huaiyun.pcbaby.com.cn/yunqian/yichuan/index_%d.html" % p for p in range(1, 10)
#                  ] + [
#                      "https://huaiyun.pcbaby.com.cn/fenmian/daichan/index_%d.html" % p for p in range(1, 10)
#                  ] + [
#                      "https://huaiyun.pcbaby.com.cn/fenmian/fangshi/index_%d.html" % p for p in range(1, 10)
#                  ]
#
...
#             # con_urls = ['https://huaiyun.pcbaby.com.cn/yunqian/zhunbei/0901/359000.html',
#             #             'https://huaiyun.pcbaby.com.cn/447/4476764.html',
#             #             'https://huaiyun.pcbaby.com.cn/452/4520264.html',
#             #             'https://huaiyun.pcbaby.com.cn/447/4476685.html']
...
#         #     next_page = response.css("div#pages.pcbaby_page a.next::attr(href)")
#         #     if next_page:
...
#             tbody = tbody.replace('src="//www1.pcbaby.com.cn/images/blank.gif"', '')
#             tbody = tbody.replace('#src', 'src')
#
#             tbody = filter_common_html(tbody)  # 过滤常见的 HTML 标签和属性
#             # 其他过滤
#             tbody = tbody.replace('<p>点击图片进入下一页&gt;&gt;</p>', '')
#             re_sub = "<p>本文链接.*"
...
#     execute(['scrapy', 'crawl', 'huaiyun_pcbaby_com_cn'])
